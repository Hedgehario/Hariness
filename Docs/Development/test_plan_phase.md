...
| TC-AUTH-06 | セッション期限切れ   | **PARTIAL**| Browser Verified | 非ログイン時のリダイレクトは確認済。ログイン不可(RateLimit)のためタイムアウト未検証。 |
...
| ID       | テスト項目         |   結果   | 確認手法            | 備考                                                  |
| :------- | :----------------- | :------: | :------------------ | :---------------------------------------------------- |
| TC-HH-01 | 登録数上限         | **BLOCKED**| Script/Browser      | **Rate Limit** により新規ユーザー作成不可のため未検証。 |
